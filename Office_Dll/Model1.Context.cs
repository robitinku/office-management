...
namespace Office_Dll
{
    ...
    public partial class Office_ManagementEntities : DbContext
    {
        public Office_ManagementEntities()
            : base("name=Office_ManagementEntities")
        {
        }
        ...
        public virtual DbSet<db_benifit> db_benifit { get; set; }
        ...
        public virtual DbSet<TMDATA> TMDATAs { get; set; }
